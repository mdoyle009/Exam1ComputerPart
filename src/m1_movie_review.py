...
def rating():
    raw_movie_rating = input("Please enter a movie rating (1-5): ")
    movie_rating = float(raw_movie_rating)
    return movie_rating
...
def review():
    movie_review = input("Please enter a brief review: ")
    return movie_review
